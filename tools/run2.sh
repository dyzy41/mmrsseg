...
python tools/train.py configs/0seg_ab/baseline_clip.py --work-dir work_dirs_ab/baseline_clip
bash tools/test.sh WHUB configs/0seg_ab/baseline_clip.py 1 work_dirs_ab/baseline_clip