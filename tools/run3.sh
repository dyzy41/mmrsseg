...
python tools/train.py configs/0seg_ab/baseline_clip_mmfpn_swin.py --work-dir work_dirs_ab/baseline_clip_mmfpn_swin
bash tools/test.sh WHUB configs/0seg_ab/baseline_clip_mmfpn_swin.py 1 work_dirs_ab/baseline_clip_mmfpn_swin